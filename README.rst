...
We need to update `https://github.com/napakalas/flatmap-datamaker/blob/main/datamaker/data_mapping.json` in for a newly published version. The code, by default, will load the updated file.